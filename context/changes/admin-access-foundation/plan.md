...
- [ ] 2.1 supabase db reset succeeds with RLS migration applied
- [ ] 2.2 RLS enabled on classes table
- [ ] 2.3 RLS enabled on reservations table

#### Manual

- [ ] 2.4 Anon SELECT on classes returns rows
- [ ] 2.5 Client SELECT on reservations returns only own rows
- [ ] 2.6 Manager or admin SELECT on reservations returns all rows
- [ ] 2.7 Client INSERT on classes is rejected by RLS
- [ ] 2.8 anon no longer has EXECUTE on create_reservation

### Phase 3: Application layer

#### Automated

- [ ] 3.1 TypeScript compiles with updated App.Locals
- [ ] 3.2 Lint passes

#### Manual

- [ ] 3.3 /admin redirects client to /dashboard
- [ ] 3.4 /admin passes for admin or manager role
- [ ] 3.5 /admin redirects unauthenticated to /auth/signin
- [ ] 3.6 context.locals.role resolves for regular and promoted user
...
- [ ] 4.4 Full admin access flow verified end-to-end
- [ ] 4.5 Client access flow verified end-to-end
- [ ] 4.6 Handoff note covers S-04 contract and references ui-design.md
